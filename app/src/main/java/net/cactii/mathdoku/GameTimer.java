...
public class GameTimer extends AsyncTask<Void, Long, Long> {
     ...
     *
     * @param cheatPenaltyType The cheat for which the elapsed time has to be increased.
     */
     ...
     *
     * @param cheatPenaltyType The cheat for which the elapsed time has to be increased.
     * @param occurences       The number of occurrences this penalty has to be added.
     */
