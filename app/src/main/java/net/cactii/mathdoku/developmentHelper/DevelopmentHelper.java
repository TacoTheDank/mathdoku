...
public class DevelopmentHelper {
     ...
     *
     * @param puzzleFragmentActivity The main activity in which context the menu item was selected.
     ...
     * Delete database.
     *
     * @param context The activity in which context the confirmation dialog will be
     *                shown.
     */
     ...
     *
     * @param puzzleFragmentActivity The activity in which context the preferences are resetted.
     * @return
     */
     ...
     *
     * @param puzzleFragmentActivity The activity in which context the preferences are reseted.
     */
     ...
     *
     * @param puzzleFragmentActivity The activity for which the database has to be deleted.
     */
     ...
     *
     * @param puzzleFragmentActivity The activitity in which context the database is checked.
