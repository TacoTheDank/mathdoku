...
public class GridCage {
     ...
     *
     * @param grid The grid in which this cage is defined.
     */
     ...
     * Creates a new instance of {@link GridCage}.
     *
     * @param grid         The grid in which the cage is defined.
     * @param hideOperator True in case the grid can be solved without using the
     ...
     *
     * @param resultValue  The resulting value of the cage when applying the given action
     *                     on the cell values in the cage.
     * @param action       The action to be applied on the cell values in this cage.
     * @param hideOperator True in case the operator of this cage can be hidden but the
     ...
     *
     * @param forceBorderReset True if borders should always be reset. False in case borders
     ...
     *
     * @param line The line containing the cage information.
     ...
     *
     * @param grid The grid to which the cage belongs.
     */
