...
public class CellChange {
     ...
     *
     * @param cell                   The cell to which the undo information is related.
     * @param previousUserValue      The user value of the cell before it is changed.
     * @param previousPossibleValues The possible values of the cell before it is changed.
     */
     ...
     *
     * @param relatedCellChange The cell change which will be related to this cell change.
     */
     ...
     * @param cells The list of cells to which undo information can be related.
     ...
     * GridCell#toStorageString()} before.
     *
     * @param revisionNumber The version of the cell change information.
     * @param line           The line containing the cell information.
     * @param level          The level of recursion. The top level should start at 1.
     * @param cells          The list of cells to which undo information can be related.
     * @return True in case the given line contains cell information and is
     * processed correctly. False otherwise.
     */
