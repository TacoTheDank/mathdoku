...
public class GridCell {
     ...
     *
     * @param digit The digit which has to be added.
     ...
     *
     * @param digit The digit which has to be removed.
     ...
     *
     * @param digit The new value for the cell. Use 0 to clear the cell.
     */
     ...
     *
     * @param line The line containing the cell information.
     ...
     *
     * @param originalCellChange Use null in case this cell change is a result of a
     ...
     *
     * @param digit The digit which is to be checked.
     ...
     *
     * @param grid The grid the cell should refer to.
     */
     ...
     * given coordinates.
     *
     * @param row    Row number (zero based) of cell to compare with.
     * @param column Column number (zero based) of cell to compare with.
     ...
     *
     * @param canvas The canvas on which will be drawed.
     * @param left   Starting X position.
     * @param top    Starting Y position.
     * @param right  Ending X position.
     * @param bottom Ending Y position.
     */
     ...
     * @param cell2 Second cell. This cell may be null in which case only the
     ...
     *
     * @param higlighted True in case the duplicate highlight is visble. False
     *                   otherwise.
     */
