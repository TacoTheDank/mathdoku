...
public class GridViewerView extends View {
     ...
     *
     * @param maxSize The maximum size (width and height) to be used for the grid
     *                view.
     */
     ...
     * view.
     *
     * @param inScrollView True in case the grid viewer view is displayed inside a scroll
