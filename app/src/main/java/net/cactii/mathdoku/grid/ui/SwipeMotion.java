...
public class SwipeMotion {
     ...
     *
     * @param grid The grid for which a swipe motion is made.
     */
     ...
     * given digit.
     *
     * @param digit The digit for which the middle of the swipe segment has to be
     *              determined.
     ...
     *
     * @param digit The digit of the segment for which the angle has to be
     ...
     *
     * @param event The event which is registered as the touch down event of the
     *              swipe motion.
     ...
     *
     * @param coordinates The (x,y) coordinates which have to be compared with the
     ...
     *
     * @param visible True in case the swipe motion has been drawn. False otherwise.
     */
     ...
     *
     * @param event The event which holding the current swipe position.
     */
     ...
     *
     * @param xPos The absolute x-position on the display
     * @param yPos The absolute y-position on the display
     ...
     * range.
     *
     * @param minimum The minimum value (should be 1)
     * @param maximum The maximum value (value from 1 to 9)
