...
public class Grid {
     ...
     *
     * @param replay True if clear is needed for replay of a finished grid. False
     *               otherwise.
     */
     ...
     *
     * @param cell The cell to be selected. If null, then the current selected
     ...
     * selected cell.
     *
     * @param originalCellChange The cell which was originally changed.
     */
     ...
     *
     * @param line The line containing the view information.
     ...
     * the process (false).
     *
     * @param gameSeed                The game seed used to generate this grid.
     * @param generatorRevisionNumber The revision number of the generator used to create the grid.
     * @param gridSize                The size of grid.
     * @param cells                   The list of cell used in the grid.
     * @param cages                   The list of cages used in the grid.
     * @param active                  The status of the grid.
     */
     ...
     *
     * @param statisticsCounterType The counter which has to be increased.
     */
     ...
     *
     * @param statisticsCounterType The counter which has to be decreased.
     */
     ...
     * Save this grid (solving attempt and statistics).
     *
     * @param saveDueToUpgrade False (default) in case of normal save. True in case saving is
     ...
     *
     * @param solvingAttemptId The unique id of the solving attempt which has to be loaded.
     ...
     * possible value).
     *
     * @param checkPossibles Also check possible values to determine whether grid is empty.
     ...
     *
     * @param gridCell The grid cell for which it has to be checked whether its value
