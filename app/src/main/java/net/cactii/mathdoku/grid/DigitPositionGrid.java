...
public class DigitPositionGrid {
     ...
     *
     * @param index The index for which the visibility has to be retrieved.
     ...
     *
     * @param index The index for which the value has to be retrieved.
     ...
     *
     * @param index The index for which the row has to be retrieved.
     ...
     *
     * @param index The index for which the column has to be retrieved.
     ...
     *
     * @param digit The digit for which the row has to be retrieved.
     ...
     *
     * @param digit The digit for which the column has to be retrieved.
