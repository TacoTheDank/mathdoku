...
public class SolvingAttemptDatabaseAdapter extends DatabaseAdapter {
     ...
     *
     * @param grid The grid for which a new solving attempt record has to be
     *             inserted.
     * @param data The data for the solving attempt.
     ...
     *
     * @param solvingAttemptId The solving attempt id for which the data has to be retrieved.
     ...
     *
     * @param id               The id of the solving attempt to be updated.
     * @param data             The data string to be stored for this solving attempt.
     ...
     *
     * @param grid The grid to which the solving attempt applies.
     ...
     *
     * @param gridId The grid id for which the number of solving attempts has to be
     *               determined.
