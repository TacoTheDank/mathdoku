...
public class GridDatabaseAdapter extends DatabaseAdapter {
     ...
     * Creates the table.
     *
     * @param db The database in which the table has to be created.
     */
     ...
     *
     * @param db         The database in which the table has to be updated.
     * @param oldVersion The old version of the database. Use the app revision number
     *                   to identify the database version.
     * @param newVersion The new version of the database. Use the app revision number
     *                   to identify the database version.
     */
     ...
     *
     * @param column The column name which has to be prefixed.
     ...
     *
     * @param grid The grid which has to be inserted into the database.
     * @return The unique rowid of the grid created. -1 in case of an error.
     * @throws InvalidParameterException In case the definition is empty or null.
     * @throws SQLException              In case the definition is not unique.
     */
     ...
     *
     * @param id The unique row id of the grid to be found.
     ...
     *
     * @param definition The unique grid definition of the grid to be found.
     * @return The grid with the given definition. Null in case of an error.
     */
    public GridRow getByGridDefinition(String definition) {
        GridRow gridRow = null;
        try (Cursor cursor = mSqliteDatabase.query(true, TABLE, allColumns,
    ...
    public int[][] getLatestSolvingAttemptsPerGrid(StatusFilter statusFilter,
        ...
        int[][] gridIds = null;
        try (Cursor cursor = sqliteQueryBuilder.query(mSqliteDatabase,
     ...
     * filter.
     *
     * @param sizeFilter The size filter which has to be matched by the grids.
    ...
    public StatusFilter[] getUsedStatuses(SizeFilter sizeFilter) {
        ...
        try (Cursor cursor = sqliteQueryBuilder.query(mSqliteDatabase, columnsData,
     ...
     * filter.
     *
     * @param statusFilter The status filter which has to be matched by the grids.
     ...
     *
     * @param statusFilter The status filter to be matched.
     ...
     *
     * @param sizeFilter The size filter to be matched.
     * @return The SQL where clause which matches solving attempts with the
     * given size filter.
     */
