...
public class StatisticsDatabaseAdapter extends DatabaseAdapter {
     ...
     *
     * @param grid The grid for which a new statistics record has to be inserted.
     ...
     *
     * @param id The unique row id of the statistics to be found.
     ...
     *
     * @param gridId The grid id for which the most recent statistics have to be
     *               determined.
     ...
     *
     * @param gridStatistics The statistics to be updated.
     ...
     *
     * @param minGridSize The minimum size of the grid for which the cumulative
     *                    statistics have to be determined.
     * @param maxGridSize The maximum size of the grid for which the cumulative
     ...
     *
     * @param gridId           The grid id for which the solving attempts have to changed.
     * @param solvingAttemptId The solving attempt which has to be included for the grid when
