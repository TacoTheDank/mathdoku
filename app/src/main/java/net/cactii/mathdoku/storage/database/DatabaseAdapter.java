...
public abstract class DatabaseAdapter {
     ...
     * @param datatype   Datatype of new column. Must be a valid SQLite datatype: blob,
     *                   bool, char, datetime, double, float, integer, numeric, real,
     *                   text or varchar.
     * @param constraint Optional constraint or modifiers for column. For example:
     ...
     *
     * @param column         Name of column in the table to be created.
     * @param refersToTable  The name of the table which is referenced by this foreign key.
     * @param refersToColumn The name of the column in the reference table to which this
     *                       foreign key maps.
     ...
     * @param elements 1 or more column definitions and or foreign keys which are
     ...
     * column names.
     *
     * @param string The string which needs to be prefixed and suffixed with back
     *               ticks.
     ...
     * SQlite.
     *
     * @param string The string which needs to be prefixed and suffixed with
     *               quotes.
     ...
     *
     * @param value The boolean string value to be converted.
     ...
     *
     * @param sqliteDatabase   The database to be used by the adapter.
     * @param tableName        The table name.
     * @param columnsToDropped The array of columns to be dropped.
     * @param createSQL        The SQL statement to create the new version of the table.
     ...
     *
     * @param sqliteDatabase The database to be used by the adapter.
     * @param tableName      The table for which the actual columns have to be determined.
