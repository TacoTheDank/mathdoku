...
public class Projection extends HashMap<String, String> {
     ...
     *
     * @param targetColumn The name of the target column. Its name should be unique for
     *                     this projection. This is not checked by this method.
     * @param sourceTable  Name of table in which the source column can be found.
     * @param sourceColumn Name of column on which the aggregation function will be
     *                     applied to determine the value of the target column.
     */
     ...
     *
     * @param aggregation  The aggregation to be used.
     * @param sourceTable  Name of table in which the source column can be found.
     * @param sourceColumn Name of column on which the aggregation function will be
