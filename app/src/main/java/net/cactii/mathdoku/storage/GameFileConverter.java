...
public class GameFileConverter extends AsyncTask<Void, Void, Void> {
     ...
     *
     * @param activity       The activity which started this {@link GameFileConverter}.
     * @param currentVersion The last version of the app which was used.
     * @param newVersion     The new version to which will be upgraded.
     */
     ...
     *
     * @param activity The activity to which results will be sent on completion of
     *                 this task.
     */
