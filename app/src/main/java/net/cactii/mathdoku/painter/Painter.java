...
public class Painter {
     ...
     *
     * @param thin True in case a small border needs to be set. False in case a
     ...
     * @param digitPositionGrid The digit position grid used to display maybe values into a
     *                          grid.
     */
     ...
     *
     * @param gridTheme The theme for which the path effect has to be set.
     */
     ...
     *
     * @param distinctColors True in case distinct colors should be used dependent on the
