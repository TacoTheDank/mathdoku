...
public class Preferences {
     ...
     *
     * @param context The context for which the preferences have to be determined.
     */
     ...
     *
     * @param context The context in which the GridPainter is created.
     ...
     *
     * @param previousInstalledVersion The old version installed.
     * @param currentVersion           The new version to which the preferences need to be upgraded.
     */
     ...
     *
     * @param tip  The name of the tip.
     * @param time The time at which the tip was last displayed.
     */
     ...
     *
     * @param statusFilter The status filter which has to be saved as last selected in
     *                     the archive.
     */
     ...
     *
     * @param sizeFilter The size filter which has to be saved as last selected in the
     *                   archive.
     */
     ...
     * to storage.
     *
     * @param preferenceName The name of the preferences counter.
     ...
     *
     * @param digit The digit for which the preference has to be determined.
     ...
     *
     * @param digit The digit for which the counter has to be determined.
     ...
     *
     * @param gridSize The grid size for which it has to be checked whether the outer
