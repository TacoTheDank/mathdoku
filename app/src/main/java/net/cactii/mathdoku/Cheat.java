...
public class Cheat {
     ...
     * penalty.
     *
     * @param context   The context in which the cheat is created.
     * @param cheatType The type of cheat to be created.
     */
     ...
     *
     * @param context                       The context in which the cheat is created.
     * @param occurrencesConditionalPenalty The number of occurrences of the conditional penalty.
     * @param cheatType                     The type of cheat to be created.
     */
    public Cheat(Context context, CheatType cheatType,
     ...
     * string.
     *
     * @param penaltyTime The penalty time in mili seconds.
