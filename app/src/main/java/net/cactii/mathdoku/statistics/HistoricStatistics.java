...
public class HistoricStatistics {
     ...
     * point.
     *
     * @param serie              The serie to be converted. Use null in case it needs to be
     *                           checked if at least one data point exists for any of the
     *                           series.
     * @param includeElapsedTime True in case the elapsed time should be included in the values
     *                           of the return series.
     * @param includeCheatTime   True in case the cheat time should be included in the values
     *                           of the return series.
     ...
     * @param title              The title to be used in the XYSeries.
     * @param scale              The scaling factor which has to be applied when converting
     *                           values.
     * @param includeElapsedTime True in case the elapsed time should be included in the values
     *                           of the return series.
     * @param includeCheatTime   True in case the cheat time should be included in the values
     ...
     *
     * @param title The title to be used in the XYSeries.
     * @param maxY  The maximum Y value to be used for each game in which the
    ...
    private class SeriesSummary {
         ...
         *
         * @param value The value which has to be included in the summary.
         */
