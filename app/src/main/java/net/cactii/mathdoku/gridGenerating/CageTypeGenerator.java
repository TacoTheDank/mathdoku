...
public class CageTypeGenerator {
     ...
     * this list.
     *
     * @param newCageTypeMatrix The cage type matrix which has to be added to the list of
     ...
     *
     * @param cageTypeIndex The index of the cage type to be retrieved.
     ...
     *
     * @param cellsUsed The number of cells the cage consists of.
     * @param maxWidth  The maximum width 0f the cell. Use 0 in case width does not
     *                  matter.
     * @param maxHeight The maximum height 0f the cell. Use 0 in case width does not
     *                  matter.
     * @param random    The random generator to use for randomized decisions.
     * @return A cage type.
     */
     ...
     * cage types.
     *
     * @param cageType        The cage type to be used as base to generate a new cage type.
     * @param extendWithCells The number of cells with which the given cage type will be
     *                        extended.
     * @param maxWidth        The maximum width 0f the cell. Use 0 in case width does not
     *                        matter.
     * @param maxHeight       The maximum height 0f the cell. Use 0 in case width does not
     *                        matter.
     * @param random          The randomize which should be used for random decisions.
