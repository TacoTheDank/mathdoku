...
public class GridGenerator extends AsyncTask<Void, String, Void> {
     ...
     * used.
     *
     * @param gridSize             The size of the gird to be created.
     * @param maxCageSize          The maximum number of cells in a single cage.
     * @param maxCageResult        The maximum value for the cage result.
     * @param hideOperators        True in case should be solvable without using operators.
     * @param packageVersionNumber The version number of the app used to generate the grid.
     * @param user                 The user (either the Main UI or the Development Tools menu)
     ...
     * development mode.
     *
     * @param gridGeneratorOptions The additional options to be set.
     */
     ...
     *
     * @param attemptCount The number of the attempt already completed plus 1.
     */
     ...
     *
     * @param hideOperators True in case cages should hide the operator. False in
     ...
     *
     * @param origin The cell at which the cage originates.
     ...
     *
     * @param cageTypeCoords  The coordinates to be used for the cage.
     * @param maxPermutations The maximum permutations allowed to create the cage. Use 0 in
     ...
     *
     * @param maskNewCage         A mask of the new cage. Cells which are in use by this cage
     *                            have value 1. Cells not used have a value -1.
     * @param maskNewCageColCount The number of rows per column in use by this new cage.
     * @return
     */
     ...
     * @param maskNewCage         A mask of the new cage. Cells which are in use by this cage
     *                            have value 1. Cells not used have a value -1.
     * @param maskNewCageRowCount The number of columns per row in use by this new cage.
     * @return
     */
     ...
     *
     * @param cage The cage for which the arithmetic has to be generated.
     */
     ...
     *
     * @param cells The cells included in the grid.
     * @param cages The cages included in the grid.
