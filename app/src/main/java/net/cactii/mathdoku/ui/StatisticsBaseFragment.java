...
public class StatisticsBaseFragment extends Fragment {
     ...
     *
     * @param color The color for the new simple series renderer.
     * @return
     */
     ...
     *
     * @param tag           The tag which can be used to identify the view.
     * @param title         The title of this section. Null in case no title has to be
     *                      displayed.
     * @param subTitle      The subtitle of this section. Null in case no subtitle has to
     *                      be displayed.
     * @param explanation   The explanatory text of this section which will be displayed
     *                      with respect to settings. Null in case explanation is never
     *                      available.
     * @param chart         The chart view. Null in case no chart has to be displayed.
     * @param extraDataView An additional view which has to be displayed between chart and
     *                      explanation.
     */
     ...
     * value).
     *
     * @param tableLayoutParams The layout parameters for the table.
     * @param label             The label (required) for the row
     * @param value             The value (optional) for the row
     ...
     *
     * @param titleHeightPixels  The height needed to display the title inclusive top and
     *                           bottom padding.
     * @param paddingChartPixels The height of the top and bottom padding set on the layout to
