...
public class PuzzleFragmentActivity extends AppFragmentActivity implements
     ...
     *
     * @param gridSize      The grid size of the new puzzle.
     * @param hideOperators True in case operators should be hidden in the new puzzle.
     */
     ...
     *
     * @param previousInstalledVersion Latest version of MathDoku which was actually used.
     * @param currentVersion           Current (new) revision number of MathDoku.
     */
     ...
     *
     * @param cancelable True in case the dialog can be cancelled.
     */
     ...
     *
     * @param solvingAttemptId The solving attempt for which the grid has to be replayed.
     * @return
     */
