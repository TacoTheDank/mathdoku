...
public class PuzzleFragment extends Fragment implements
     ...
     *
     * @param selectedCell The cell for which the user value has to be revealed.
     */
     ...
     *
     * @param cheatType The type of cheat to be processed.
     */
     ...
     *
     * @param inputMode The input mode for which the input mode button has to be set.
     */
