...
public class SharedPuzzle {
     ...
     *
     * @param context The context in which the SharedPuzzle is created.
     */
     ...
     *
     * @param view The view from which the statistics charts have to be
     *             extracted.
     ...
     *
     * @param gridDefinition The grid definition for which the share url has to be made.
