...
public class TipDialog extends AlertDialog {
     ...
     *
     * @param context  The activity in which context the tip is used.
     * @param tip      The name of the tip class.
     * @param priority The priority of this tip relative to other tip classes.
     */
     ...
     * @param tipImage The image to be shown with this tip. It is preferred to have
     ...
     *
     * @param onClickCloseListener The listener to be called upon closing the tip dialog.
